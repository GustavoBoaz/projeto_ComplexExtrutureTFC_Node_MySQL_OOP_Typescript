...
describe('4 - Verifica se é possível a partir da página LEADERBOARD navegar para as demais páginas', () => {
  let page;
...
describe('5 - Implemente a tabela de ScoreBoard para a pagina CLASSIFICAÇÃO', () => {
  let page;
